...
def get_public_key_client1():
    ...
    print("...............connection established to CA...........")
    client_socket.send("1".encode())  # send message
    data = client_socket.recv(1024)  # receive response
    data=list(data)
    data=decrypt(data,public_key)
    print("...............public key received...................")
    client_socket.close()  # close the connection
    print("...............connection closed to CA.................")
    return data
...
if __name__ == '__main__':
    private_key= [11,119]
    certificate=get_public_key_client1()
